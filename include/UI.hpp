...
extern void UI_task(Device::Dji_referee *referee_ui);
extern void UI_set_fric(uint8_t mode);
extern void UI_set_spin(uint8_t mode);
extern int String_ReFresh(Device::Dji_referee *referee_ui, String_Data string_Data);
extern void String_Draw(String_Data *image,std::string imagename,u32 Graph_Operate,u32 Graph_Layer,u32 Graph_Color,u32 Graph_Size,u32 Graph_Digit,u32 Graph_Width,u32 Start_x,u32 Start_y,std::string String_Data);
extern void UI_Delete(Device::Dji_referee *referee_ui, u8 Del_Operate,u8 Del_Layer);
...
void Char_Draw(String_Data *image,std::string imagename,u32 Graph_Operate,u32 Graph_Layer,u32 Graph_Color,u32 Graph_Size,u32 Graph_Digit,u32 Graph_Width,u32 Start_x,u32 Start_y,std::string Char_Data);
...
extern void custom_ui_task(Device::Dji_referee *referee_ui);
extern void custom_UI_init(Device::Dji_referee *referee_ui);
